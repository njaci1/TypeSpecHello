import { getNamespaceFullName, getService, getTypeName, isTemplateInstance, navigateProgram, NoTarget, } from "@typespec/compiler";
...
export function $onValidate(program) {
    ...
    navigateProgram(program, {
        ...
        namespace: (namespace) => {
            ...
            if ((serviceProps === null || serviceProps === void 0 ? void 0 : serviceProps.version) !== undefined && versionMap !== undefined) {
