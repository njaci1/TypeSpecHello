...
export type IntrinsicScalarName = "bytes" | "numeric" | "integer" | "float" | "int64" | "int32" | "int16" | "int8" | "uint64" | "uint32" | "uint16" | "uint8" | "safeint" | "float32" | "float64" | "string" | "plainDate" | "plainTime" | "utcDateTime" | "offsetDateTime" | "duration" | "boolean" | "url";
...
export interface ProjectionStatementNode extends BaseNode, DeclarationNode {
    ...
    readonly selector: ProjectionModelSelectorNode | ProjectionModelPropertySelectorNode | ProjectionInterfaceSelectorNode | ProjectionOperationSelectorNode | ProjectionUnionSelectorNode | ProjectionUnionVariantSelectorNode | ProjectionEnumSelectorNode | ProjectionEnumMemberSelectorNode | MemberExpressionNode | IdentifierNode;
